<template>
  <div>
    <Flipper :flip-key="settings" class="w-full h-full bg-gray-800 grid grid-cols-4 place-items-auto px-12 py-8 gap-6">
...
export default Vue.extend({
  components: {
    AppStore, Loop, Awtrix, Connectivity, Flipper, Flipped,
  },
